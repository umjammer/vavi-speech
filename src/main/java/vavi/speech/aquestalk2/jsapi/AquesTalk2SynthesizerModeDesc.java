 ...
 */
public class AquesTalk2SynthesizerModeDesc extends SynthesizerModeDesc implements EngineCreate {
     ...
     */
    public AquesTalk2SynthesizerModeDesc(String engineName, String modeName, Locale locale) {
    ...
    public Engine createEngine() throws IllegalArgumentException, EngineException, SecurityException {
        AquesTalk2Synthesizer s = new AquesTalk2Synthesizer(this);
        return s;
    }
}
